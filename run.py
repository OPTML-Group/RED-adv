...
if __name__ == "__main__":
    ...
    # run_commands([0, 1] * 2, commands, call=False,
    #              dir="commands", shuffle=False, delay=0.5)

    commands = gen_commands_victim()
    print(len(commands))
    run_commands([0, 1, 4] * 4 + [5, 6, 7] * 3, commands, call=True, ext_command=" --dataset-dir /tmp/cifar{i}",
                 suffix="commands", shuffle=True, delay=1)
